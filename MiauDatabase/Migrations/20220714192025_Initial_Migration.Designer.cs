...
namespace MiauDatabase.Migrations
{
    ...
    [Migration("20220714192025_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiauDatabase.Entities.AddressEntity", b =>
                {
                    ...
                    b.Property<int>("UserRelId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("user_rel_id");

                    b.HasKey("Id")
                        .HasName("pk_addresses");

                    b.HasIndex("UserRelId")
                        .HasDatabaseName("ix_addresses_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.AppointmentEntity", b =>
                {
                    ...
                    b.Property<int>("PetIdFK")
                        .HasColumnType("INTEGER")
                        .HasColumnName("pet_id_fk");

                    b.Property<int>("PetRelId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("pet_rel_id");
                    ...
                    b.HasIndex("PetRelId")
                        .HasDatabaseName("ix_appointments_pet_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PetEntity", b =>
                {
                    ...
                    b.HasIndex("UserRelId")
                        .HasDatabaseName("ix_pets_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.ProductImageEntity", b =>
                {
                    ...
                    b.Property<int>("ProductRelId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("product_rel_id");

                    b.HasKey("Id")
                        .HasName("pk_product_images");

                    b.HasIndex("ProductRelId")
                        .HasDatabaseName("ix_product_images_product_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.ProductReviewEntity", b =>
                {
                    ...
                    b.HasIndex("ProductRelId")
                        .HasDatabaseName("ix_product_reviews_product_rel_id");

                    b.HasIndex("UserRelId")
                        .HasDatabaseName("ix_product_reviews_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PurchasedProductEntity", b =>
                {
                    ...
                    b.Property<int>("PurchaseIdFK")
                        .HasColumnType("INTEGER")
                        .HasColumnName("purchase_id_fk");

                    b.Property<int>("PurchaseRelId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("purchase_rel_id");
                    ...
                    b.HasIndex("ProductRelId")
                        .HasDatabaseName("ix_purchased_products_product_rel_id");

                    b.HasIndex("PurchaseRelId")
                        .HasDatabaseName("ix_purchased_products_purchase_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PurchaseEntity", b =>
                {
                    ...
                    b.HasIndex("UserRelId")
                        .HasDatabaseName("ix_purchases_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.WishlistEntity", b =>
                {
                    ...
                    b.HasIndex("ProductRelId")
                        .HasDatabaseName("ix_wishlist_product_rel_id");

                    b.HasIndex("UserRelId")
                        .HasDatabaseName("ix_wishlist_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.AddressEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.UserEntity", "UserRel")
                        .WithMany("AddressesRel")
                        .HasForeignKey("UserRelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_addresses_users_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.AppointmentEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.PetEntity", "PetRel")
                        .WithMany("AppointmentsRel")
                        .HasForeignKey("PetRelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_appointments_pets_pet_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PetEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.UserEntity", "UserRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pets_users_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.ProductImageEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.ProductEntity", "ProductRel")
                        .WithMany("ProductImagesRel")
                        .HasForeignKey("ProductRelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_images_products_product_rel_id");

                    b.Navigation("ProductRel");
                });
            ...
            modelBuilder.Entity("MiauDatabase.Entities.ProductReviewEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.ProductEntity", "ProductRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_reviews_products_product_rel_id");

                    b.HasOne("MiauDatabase.Entities.UserEntity", "UserRel")
                        .WithMany("ProductReviewsRel")
                        .HasForeignKey("UserRelId")
                        .HasConstraintName("fk_product_reviews_users_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PurchasedProductEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.ProductEntity", "ProductRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchased_products_products_product_rel_id");

                    b.HasOne("MiauDatabase.Entities.PurchaseEntity", "PurchaseRel")
                        .WithMany("PurchasedProductRel")
                        .HasForeignKey("PurchaseRelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchased_products_purchases_purchase_rel_id");

                    b.Navigation("ProductRel");

                    b.Navigation("PurchaseRel");
                });
            ...
            modelBuilder.Entity("MiauDatabase.Entities.PurchaseEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.UserEntity", "UserRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchases_users_user_rel_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.WishlistEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.ProductEntity", "ProductRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wishlist_products_product_rel_id");
                    ...
                    b.HasOne("MiauDatabase.Entities.UserEntity", "UserRel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wishlist_users_user_rel_id");
