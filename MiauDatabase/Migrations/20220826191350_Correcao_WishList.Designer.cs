...
namespace MiauDatabase.Migrations
{
    ...
    [Migration("20220826191350_Correcao_WishList")]
    partial class Correcao_WishList
    {
            ...
            modelBuilder.Entity("MiauDatabase.Entities.ProductReviewEntity", b =>
                {
                    ...
                    b.HasComment("Represents a product review.");
                });
            ...
            modelBuilder.Entity("MiauDatabase.Entities.WishListEntity", b =>
                {
                    ...
                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_wish_lists_product_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_wish_lists_user_id");
            ...
            modelBuilder.Entity("MiauDatabase.Entities.WishListEntity", b =>
                {
                    b.HasOne("MiauDatabase.Entities.ProductEntity", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wish_lists_products_product_id");
                    ...
                    b.HasOne("MiauDatabase.Entities.UserEntity", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wish_lists_users_user_id");
