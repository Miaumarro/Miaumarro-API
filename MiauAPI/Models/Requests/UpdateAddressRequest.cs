...
/// <summary>
/// Represents a request for update an address by a given Id.
/// </summary>
...
public sealed record UpdateAddressRequest(int Id, int UserId, string State, string City, string Neighborhood, string Cep, string Address, int AddressNumber, string? Complement, string? Reference, string? Destinatary);