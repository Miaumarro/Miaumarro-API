...
public sealed record UpdateAddressRequest(int Id, int UserId, string Address, int Number, string? Reference, string? Complement, string Neighborhood, string City, string State, string? Destinatary, string Cep);
